""" Evaluate available methods on the post-nonlinear dataset.

The results are saved to results/pnl_results.pkl.
"""
import os
import joblib
from independence_test.utils import pc_ks
from independence_test.data import make_pnl_data as make_data
