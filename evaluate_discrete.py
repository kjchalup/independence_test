""" Evaluate available methods on the discrete dataset.

The results are saved to results/discrete_results.pkl.
"""
import os
import joblib
from independence_test.utils import pc_ks
from independence_test.data import make_discrete_data as make_data
...
SAVE_FNAME = 'discrete_results.pkl'
